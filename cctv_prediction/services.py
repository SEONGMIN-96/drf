from common.entity import Dataset
...
class Service(Reader):
    ...
    def save_police_norm(self):
        ...
        police.drop(columns={'살인 검거', '강도 검거', '절도 검거', '폭력 검거', '강간 검거'}, axis=1, inplace=True)
    ...
    def save_folium_map(self):
        # police_norm.csv -> police_norm
        # kr-states.json
        # crime_in_seoul.csv -> crime
        # police_pos.csv -> police_pos
